...
alias shutdown='~/.config/ml4w/scripts/ml4w-session poweroff'
alias v='$EDITOR'
alias vim='$EDITOR'
alias wifi='~/.config/ml4w/scripts/ml4w-network open'
...
alias lock='~/.config/ml4w/scripts/ml4w-session lock'
alias clock='tty-clock'
alias system='~/.config/ml4w/settings/system-monitor.sh'
...
alias ml4w-hyprland='~/.config/ml4w/scripts/ml4w-hyprland-settings run'
